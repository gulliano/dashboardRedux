  ...
  return (
    ...
    <div>
        ...
        <ul className="space-y-2 tracking-wide mt-8">
            <li>
                <Link to="/" aria-label="dashboard" className="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400">
            ...
            <li>
                <Link to="/category" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
            ...
            <li>
                <Link to="/question" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <span className="group-hover:text-gray-700">Action ou Vérité</span>
                </Link>
            </li>
            <li>
